...
**v1.5.2 is the current stable release. v1.6.0-rc.5 is the current release candidate.**
...
- Complete published-package validation of v1.6.0-rc.5 on Raspberry Pi 4 and confirm acceptable Pi 3B resource use.
