...
func TestClientFetchParsesLatestIndicatorRowByHeading(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, _ *http.Request) {
		...
		fmt.Fprint(w, `[{
            ...
            "modified_gmt":"2026-08-24T11:42:30",
	...
	sourceUpdatedAt := time.Date(2026, 8, 24, 11, 42, 30, 0, time.UTC)
	if got.Source != SourceName || got.SourceUpdatedAt != sourceUpdatedAt || got.FetchedAt != fetchedAt {
