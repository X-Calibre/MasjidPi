...
reset_boot_files
mkdir -p "$MASJIDPI_PLYMOUTH_THEME_DIR"
touch "$MASJIDPI_PLYMOUTH_THEME_DIR/masjidpi-splash-logo-appliance.png"
...
[[ ! -e "$MASJIDPI_PLYMOUTH_THEME_DIR/masjidpi-splash-logo-appliance.png" ]]
