...
export MASJIDFRAME_DEVICE_MODEL_PATH="$TEST_ROOT/model"
export MASJIDFRAME_NETWORKMANAGER_CONF_DIR="$TEST_ROOT/conf"
...
printf 'Generic Linux computer\0' > "$MASJIDFRAME_DEVICE_MODEL_PATH"
TEST_NETWORKMANAGER_ACTIVE=true configure_raspberry_pi_wifi
[[ ! -e "$MASJIDFRAME_NETWORKMANAGER_CONF_DIR/masjidframe-wifi-powersave.conf" ]]
[[ ! -e "$TEST_CALLS" ]]

printf 'Raspberry Pi 4 Model B Rev 1.5\0' > "$MASJIDFRAME_DEVICE_MODEL_PATH"
TEST_NETWORKMANAGER_ACTIVE=false configure_raspberry_pi_wifi
[[ ! -e "$MASJIDFRAME_NETWORKMANAGER_CONF_DIR/masjidframe-wifi-powersave.conf" ]]

TEST_NETWORKMANAGER_ACTIVE=true configure_raspberry_pi_wifi
config="$MASJIDFRAME_NETWORKMANAGER_CONF_DIR/masjidframe-wifi-powersave.conf"
