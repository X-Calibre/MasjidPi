...
assert.match(html, /masjidboard-appliance-720\.css\?v=20260909-date-alternation/);
...
assert.match(appliance720, /\.appliance-date-line > \*\s*\{[^}]*font-size:24px;[^}]*white-space:normal;[^}]*overflow-wrap:anywhere/s);
assert.match(appliance, /let dateTimer = 0/);
assert.match(appliance, /showingGregorianDate = !showingGregorianDate/);
assert.match(appliance, /dateTimer = window\.setInterval/);
assert.match(appliance, /slideDurationSeconds \* 1000/);
