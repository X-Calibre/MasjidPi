...
assert.match(css, /body\[data-board-theme\]:not\(\[data-board-theme="emerald"\]\)/);
...
assert.match(js, /const boardURL = "\/masjidboard\.html\?profile=appliance-720"/);
assert.match(js, /classList\.add\("setup-720-layout"\)/);
assert.doesNotMatch(js, /requestedProfile/);
...
assert.match(board, /Set up MasjidBoard/);
assert.match(board, /step=location&amp;resume=1/);
